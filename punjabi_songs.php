<?php
    ...
    if(!isset($_SESSION['email_address']))
		...
		$sql = "SELECT * FROM punjabi_albums ORDER BY song_id ASC";
		$result = mysqli_query($conn,$sql);
		...
		while($rows = mysqli_fetch_array($result)){
			...
			if(isset($_POST[$song_id])){
				...
				$sql = "SELECT * FROM punjabi_albums WHERE song_id = '$song_id' ";
				$results = mysqli_query($conn,$sql);
...
<head>
	<title>Musical World | punjabi Songs</title>
	...
	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| punjabi Songs |</p>
                </li>
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
								<div class="dropdown-menu dropdown-primary">
									...
									<a class="dropdown-item" href="punjabi_songs.php"><b>punjabi Songs</b></a>
	...
	<?php
			...
			if(mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_array($result)){
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='punjabi_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/punjabi_songs/img/$song_image' style='width:350px;height:250px' alt=''>
										</div>
										<div class='card-desc'>
											<h3>$song_name | $singer_name</h3>
											<h3>movie - $movie_name</h3>
											<audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/punjabi_songs/$audio_file' type='audio/mp3'></audio><br>
